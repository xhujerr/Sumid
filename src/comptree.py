...
import sys
# import miscutil # 026
from miscutil import Shared, NotImplementedYetError,CounterManager,Debug #026 Debug class needed to support ThreadAwareLogger
...
class DistantFile(Shared):# Afaik inheritance from NodeProxy not needed.
    ...
    def writeToLocalFile(self):
        ...
        """
        # 027 Pattern analyzer moved from FilesAdaptor to here. Even thou it makes more sense, the analyzer from LeafProxy shall be used.
